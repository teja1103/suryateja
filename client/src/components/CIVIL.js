...
const CIVIL = () => {
  ...
  return (
    ...
    <div id="down">
      ...
      <img class="log" src={logo} />
        ...
        {/* <td><div class="magic">
         ...
         <tr>
          <td><p >8</p></td>
         <td><p >A221101</p></td>
          <td><p>ELEMENTS OF CIVIL ENGINEERING</p></td>
          <td><p >0</p></td>
          <td><p >0</p></td>
          <td><p >2</p></td>
          <td><p >1.0</p></td>
      ...
      <div class="reg">Academic regulations of 2022(R22)</div>
    </div>
    {/* <div class="condi"><h4>I am aware of the Academic regulations (R22)</h4></div> */}
    <div class="agree">
